 ...
 */
public class ConsultationMenuPendingFragment extends Fragment {
...
TextView txtNotAvailable;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_consultation_menu_pending, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        progressBar = view.findViewById(R.id.ckpf_spin_kit);
        txtNotAvailable=view.findViewById(R.id.ckpf_message);
        Sprite circle = new Circle();
        progressBar.setIndeterminateDrawable(circle);
        session = userSessionManager.getSessionDetails();
        linearLayoutManager = new LinearLayoutManager(context);
        refreshLayout=view.findViewById(R.id.ckpf_refresh);
        recyclerView = view.findViewById(R.id.recycler_consultationpending);
                ...
                try {
                    ...
                    if (status) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            ConsultationStatusModel model = new ConsultationStatusModel(URLHelper.BASE_IMAGE + image, name, hospital_name, time, date, statusbook, id, "", "");
                            list.add(model);
                        }
