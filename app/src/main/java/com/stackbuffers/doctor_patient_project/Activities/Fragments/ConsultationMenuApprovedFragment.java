...
import com.stackbuffers.doctor_patient_project.Adapters.ConsultationStatusAdapter;
...
public class ConsultationMenuApprovedFragment extends Fragment {
    Context context;
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_consultation_menu_approved, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        progressBar = view.findViewById(R.id.ckaf_spin_kit);
        Sprite circle = new Circle();
        progressBar.setIndeterminateDrawable(circle);
        session = userSessionManager.getSessionDetails();
        linearLayoutManager = new LinearLayoutManager(context);
        refreshLayout = view.findViewById(R.id.ckaf_refresh);
        recyclerView = view.findViewById(R.id.recycler_consultationapproved);
        txtNotAvailable = view.findViewById(R.id.ckaf_message);
    ...
    private void SetRecycler() {
        final List<ConsultationStatusModel> list = new ArrayList<>();
        progressBar.setVisibility(View.VISIBLE);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLHelper.GET_CONSULTATION_STATUS, new Response.Listener<String>() {
            @Override
                ...
                try {
                    ...
                    if (status) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            String id = object.getString("doctor_id");

                            String token = object.getString("token");
                            String channel = object.getString("channel");

                            ConsultationStatusModel model = new ConsultationStatusModel(URLHelper.BASE_IMAGE + image, name, hospital_name, time, date, statusbook, id, token, channel);
                            list.add(model);
                        }
                        ...
                        ConsultationStatusAdapter adapter = new ConsultationStatusAdapter(context, list);
