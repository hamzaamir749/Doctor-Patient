...
TextView txtNotAvailable;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.recycler_bookingrequestsdoctor);
        recyclerView.setLayoutManager(linearLayoutManager);
        progressBar = view.findViewById(R.id.brd_spin_kit);
        refreshLayout = view.findViewById(R.id.brd_refresh);
        txtNotAvailable=view.findViewById(R.id.brd_message);
    ...
    private void SetRecycler() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLHelper.GET_PENDING_APPOINTMENTS, new Response.Listener<String>() {
            @Override
                ...
                try {
                    ...
                    if (status) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            hospitalname = object.getString("hosp_name");
