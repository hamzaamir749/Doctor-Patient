...
import com.stackbuffers.doctor_patient_project.Adapters.SearchConsultantAdapter;
...
public class SearchConsultantActivity extends AppCompatActivity {
    ...
    SearchConsultantAdapter adapter;
    TextView txtNotAvailable;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_search_consultant);
    ...
    private void initViews() {
        txtNotAvailable=findViewById(R.id.searchconsultant_message);
        searchView = findViewById(R.id.searchconsultant_SearchBox);
        recyclerView = findViewById(R.id.searchconsultant_Recycler);
        linearLayoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(linearLayoutManager);
        progressBar = findViewById(R.id.searchconsultant_spin_kit);
        context = this;
        Sprite circle = new Circle();
        progressBar.setIndeterminateDrawable(circle);
        back = findViewById(R.id.search_consult_back);
    }
                ...
                try {
                    ...
                    if (status) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            SearchDoctorConsultantModel model = new SearchDoctorConsultantModel(name, Speciality, URLHelper.BASE_IMAGE + image, id,"",doctor.getString("token"));
                            list.add(model);
                        }
                        ...
                        adapter = new SearchConsultantAdapter(getApplicationContext(), list);
