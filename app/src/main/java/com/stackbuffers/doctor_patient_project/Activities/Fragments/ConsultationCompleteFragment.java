...
TextView txtNotAvailable;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_consultation_complete, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.recycler_consultationcompletedoctor);
        recyclerView.setLayoutManager(linearLayoutManager);
        progressBar = view.findViewById(R.id.ccd_spin_kit);
        txtNotAvailable=view.findViewById(R.id.ccd_message);
    ...
    private void SetRecycler() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLHelper.GET_COMPLETE_CONSULTATIONS, new Response.Listener<String>() {
            @Override
