...
public class EmergencyDoctorsActivity extends AppCompatActivity {
    ...
    private void initViews() {
        txtNotAvailable = findViewById(R.id.emergencydoctor_message);
        recyclerView = findViewById(R.id.emergencydoctor_Recycler);
        linearLayoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(linearLayoutManager);
        progressBar = findViewById(R.id.emergencydoctor_spin_kit);
        context = this;
        Sprite circle = new Circle();
        back = findViewById(R.id.emergencydoctor_back);
                ...
                try {
                    ...
                    if (status) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            SearchDoctorConsultantModel model = new SearchDoctorConsultantModel(name, Speciality, URLHelper.BASE_IMAGE + image, id, getResources().getString(R.string.contactnow),doctor.getString("token"));
                            list.add(model);
                        }
