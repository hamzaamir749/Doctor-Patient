 ...
 */
public class BookingMenuPendingFragment extends Fragment {
    Context context;
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_booking_menu_pending, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        progressBar = view.findViewById(R.id.bkpf_spin_kit);
        Sprite circle = new Circle();
        progressBar.setIndeterminateDrawable(circle);
        session = userSessionManager.getSessionDetails();
        linearLayoutManager = new LinearLayoutManager(context);
        recyclerView = view.findViewById(R.id.recycler_bookingpending);
        recyclerView.setLayoutManager(linearLayoutManager);
        refreshLayout = view.findViewById(R.id.bkpf_refresh);
        txtNotAvailable=view.findViewById(R.id.bkpf_message);
