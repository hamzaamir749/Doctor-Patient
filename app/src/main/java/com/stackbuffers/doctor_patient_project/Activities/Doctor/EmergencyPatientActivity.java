...
import com.stackbuffers.doctor_patient_project.Adapters.EPAdapter;
...
public class EmergencyPatientActivity extends AppCompatActivity {
    RecyclerView recyclerView;
    LinearLayoutManager linearLayoutManager;
    List<EPModel> list=null;
    Context context;
    ...
    private void initViews() {
        ...
        txtNotAvailable=findViewById(R.id.ep_message);
        recyclerView = findViewById(R.id.ep_Recycler);
        linearLayoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(linearLayoutManager);
        progressBar = findViewById(R.id.ep_spin_kit);
        context = this;
        back=findViewById(R.id.ep_activity_back);
    ...
    private void setRecycler() {
        ...
        StringRequest data = new StringRequest(Request.Method.POST, URLHelper.GET_EMERGECY_PATIENT, new Response.Listener<String>() {
            @Override
                ...
                try {
                    ...
                    if (status) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            String id = doctor.getString("emergency_id");
                            String channel = doctor.getString("channel");
                            String name = doctor.getString("name");
                            String image = doctor.getString("image");
                            EPModel model = new EPModel(id,name,URLHelper.BASE_IMAGE + image,channel,token);
                        ...
                        EPAdapter adapter = new EPAdapter(list, context);
