...
public class VoiceChatViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tokenn=getIntent().getExtras().getString("tokenn");
        channell=getIntent().getExtras().getString("channell");
    ...
    private void joinChannel() {
        String accessToken = tokenn;
        if (TextUtils.equals(accessToken, "") || TextUtils.equals(accessToken, "#YOUR ACCESS TOKEN#")) {
            accessToken = null; // default, no token
        }

        mRtcEngine.joinChannel(accessToken, channell, "Extra Optional Data", 0); // if you do not specify the uid, we will generate the uid for you
    }
