...
public class BookDoctorActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    private void initViews() {
        btn_chooseDate = findViewById(R.id.bookdoctor_choosedate);
        btn_chooseTime = findViewById(R.id.bookdoctor_choosetime);
        spinnerHospital = findViewById(R.id.bookdoctor_spinnerhospital);
        txt_name = findViewById(R.id.bookdoctor_name);
        txt_specility = findViewById(R.id.bookdoctor_speciality);
        txt_fee = findViewById(R.id.bookdoctor_fee);
        txt_days = findViewById(R.id.bookdoctor_days);
        btn_booknow = findViewById(R.id.bookdoctor_Booknow);
        progressDialog = new ProgressDialog(this);
        progressBar = findViewById(R.id.bookdoctor_spin_kit);
        img_imageView = findViewById(R.id.bookdoctor_profileimage);
        back = findViewById(R.id.bookdoctor_back);
        lnr_days = findViewById(R.id.bookdoctor_availabledaysetc);
        Sprite circle = new Circle();
        progressBar.setIndeterminateDrawable(circle);
        context = this;
        list = new ArrayList<>();
        sharedHelper = new SharedHelper();
        doctorID = sharedHelper.getKey(context, "did");
