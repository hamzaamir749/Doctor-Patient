 ...
 */
public class ConsultationMenuCompleteFragment extends Fragment {
...
TextView txtNotAvailable;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_consultation_menu_complete, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        progressBar = view.findViewById(R.id.ckcf_spin_kit);
        txtNotAvailable=view.findViewById(R.id.ckcf_message);
        Sprite circle = new Circle();
        progressBar.setIndeterminateDrawable(circle);
        session = userSessionManager.getSessionDetails();
        linearLayoutManager = new LinearLayoutManager(context);
        recyclerView = view.findViewById(R.id.recycler_consultationcomplete);
