...
public class BookingMenuCompleteFragment extends Fragment {
    Context context;
    View view;
   ...
   TextView txtNotAvailable;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_booking_menu_complete, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.recycler_bookingcomplete);
        recyclerView.setLayoutManager(linearLayoutManager);
        progressBar = view.findViewById(R.id.bkcf_spin_kit);
        Sprite circle = new Circle();
        txtNotAvailable=view.findViewById(R.id.bkcf_message);
